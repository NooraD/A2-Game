...
public class Q_InventoryMainEditorWindow : Q_InventoryEmptyEditorWindow
{
    ...
    void InitializeReorderableList()
    {
        if (inventoryItemList.itemList != null)
            ...
            {
                Itemm obj = inventoryItemList.itemList[itemViewIndex - 1];
    ...
    void CreateNewItemList()
    {
        ...
        if (inventoryItemList)
        {
            inventoryItemList.itemList = new List<Itemm>();
    ...
    void AddItem()
    {
        ...
        Itemm newItem = CreateItem.Create();
    ...
    void DrawCraftingEditor()
    {
        ...
        if (inventoryItemList.bluePrints.Count > 0)
        {
            ...
            if (inventoryItemList.bluePrints.Count > 0)
            {
                ...
                GUILayout.Space(5);
                //target
                inventoryItemList.bluePrints[bluePrintViewIndex - 1].targetItem = EditorGUILayout.ObjectField("Product", inventoryItemList.bluePrints[bluePrintViewIndex - 1].targetItem, typeof(Itemm), false) as Itemm;
                GUILayout.Space(5);
