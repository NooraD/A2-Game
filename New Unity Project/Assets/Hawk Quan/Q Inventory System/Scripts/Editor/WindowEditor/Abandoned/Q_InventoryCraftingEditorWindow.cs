            ...
            using (var scrollView = new EditorGUILayout.ScrollViewScope(scrollPos))
            {
                ...
                if (inventoryItemList.bluePrints.Count > 0)
                {
                    ...
                    if (inventoryItemList.bluePrints.Count > 0)
                    {
                        ...
                        GUILayout.Space(5);
                        //target
                        inventoryItemList.bluePrints[viewIndex - 1].targetItem = EditorGUILayout.ObjectField("Product", inventoryItemList.bluePrints[viewIndex - 1].targetItem, typeof(Itemm), false) as Itemm;
                        GUILayout.Space(5);
