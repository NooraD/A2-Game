...
public class Crafting : Q_Inventory {
    ...
    {
        Itemm newItem = Q_GameMaster.Instance.inventoryManager.itemDataBase.getItemByID(craftingBluePrint.targetItem.ID);
    ...
    {
        List<Itemm> items = Q_GameMaster.Instance.inventoryManager.playerInventory.items;
